...
fn main() -> Result<(), slint::PlatformError> {
    ...
    ui.on_send_entry({
        ...
        move |payload| {
            ...
            match DB.insert_appr(area.as_str(), close_date.as_str(), company.as_str(), date_applied.as_str(), level, notes.as_str(), pay, requirements.as_str(), role.as_str(), sector.as_str(), stage.as_str()) {
